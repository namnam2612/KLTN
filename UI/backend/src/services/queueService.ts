...
const MAX_CONCURRENT_USERS = getNumberEnv('QUEUE_MAX_CONCURRENT_USERS', 5);
const SESSION_TIMEOUT = getNumberEnv('QUEUE_SESSION_TIMEOUT_SECONDS', 30 * 60);
const QUEUE_TIMEOUT = getNumberEnv('QUEUE_TIMEOUT_SECONDS', 60);
